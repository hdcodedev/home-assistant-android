...
@Immutable
internal data class ShortcutEditorUiState(
    ...
    @Immutable
    data class AppCreateState(override val initialDraft: ShortcutDraft) : AppEditorState

    @Immutable
    data class AppEditState(override val initialDraft: ShortcutDraft, val appIndex: Int) : AppEditorState {
    ...
    @Immutable
    data class HomeCreateState(override val initialDraft: ShortcutDraft) : HomeEditorState

    @Immutable
    data class HomeEditState(override val initialDraft: ShortcutDraft, val shortcutId: String) : HomeEditorState {
        override val isEditing: Boolean = true
    }
}
