...
@Immutable
data class ShortcutData(val servers: List<ShortcutServerItem>, val draftSeed: ShortcutDraft, val mode: ShortcutMode)

@Immutable
data class ShortcutServerItem(val server: Server, val data: ServerData)
