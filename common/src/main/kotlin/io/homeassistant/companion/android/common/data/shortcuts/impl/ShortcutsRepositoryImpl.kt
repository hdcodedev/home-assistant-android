...
internal class ShortcutsRepositoryImpl @Inject constructor(
    ...
    private data class EditorContext(val defaultServerId: Int, val servers: List<ShortcutServerItem>)
    ...
    private suspend fun saveAppShortcut(index: Int?, shortcut: ShortcutDraft): ShortcutResult<Unit> {
        if (!isShortcutsSupported) {
            return ShortcutResult.Error(ShortcutError.ApiNotSupported)
        }
